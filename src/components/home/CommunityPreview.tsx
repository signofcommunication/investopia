  ...
  return (
    <section className="py-20 bg-white">
      <div className="container mx-auto px-8 text-center">
        ...
        <Typography className="text-gray-600 max-w-xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="flex justify-center gap-8 flex-wrap">
          {/* WhatsApp */}
          <Card className="w-60 shadow-md hover:shadow-xl transition-all duration-300 rounded-xl hover:-translate-y-1">
